			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 " >
	               <div class="team-member text-center">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-responsive" src="{{ asset('images/team/member-1.jpg')}}" alt="Meghna">
							<!-- /member photo -->
				...
				<div class="col-md-4 col-sm-6 " >
	               <div class="team-member text-center">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-responsive" src="{{ asset('images/team/member-2.jpg')}}" alt="Meghna">
							<!-- /member photo -->
				...
				<div class="col-md-4 col-sm-6 ">
	               <div class="team-member text-center">
						<div class="member-photo">
							<!-- member photo -->
							<img class="img-responsive" src="{{ asset('images/team/member-3.jpg')}}" alt="Meghna">
							<!-- /member photo -->
